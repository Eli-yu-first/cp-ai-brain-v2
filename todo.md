...
- [ ] 新增左侧菜单中的 AI 决策标签与独立 AI 决策页面，在完成页面路由、导航联通与界面验证后提交到 GitHub
- [ ] 实现预测交互区、月份与预估价格输入、价格波动曲线、利润成本平均售价联动计算，并在完成前后端联调验证后提交到 GitHub
- [ ] 实现 What-If 多变量情景模拟，支持价格、产能、需求调整及 1 到 3 个月屠宰和仓储资源自动测算，并在完成结果验证后提交到 GitHub
